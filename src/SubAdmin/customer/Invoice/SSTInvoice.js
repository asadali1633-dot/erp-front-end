                        ...
                        <View style={{ flex: 1 }}>
                            {pageIndex === 0 && (
                                <>
                                    ...
                                    <Text style={styles.taxHead}>Sindh Service Tax Invoice</Text>
                                            ...
                                            <View style={styles.quoteBox}>
                                                {
                                                    invoice_number ?
                                                        <View style={styles.rowBetween}>
                                                            <Text style={[styles.headertxt, styles.colorWhite]}>Invoice Number:</Text>
                                                            <Text style={[styles.headertxt, styles.colorWhite]}>{invoice_number}</Text>
                                                        </View> : null
                                                }
                                                {
                                                    invoice_date ?
                                                        <View style={styles.rowBetween}>
                                                            <Text style={[styles.headertxt, styles.colorWhite]}>Invoice Date:</Text>
                                                            <Text style={[styles.headertxt, styles.colorWhite]}>{invoice_date}</Text>
                                                        </View> : null
                                                }
                                                {
                                                    due_date ?
                                                        <View style={styles.rowBetween}>
                                                            <Text style={[styles.headertxt, styles.colorWhite]}>Due Date:</Text>
                                                            <Text style={[styles.headertxt, styles.colorWhite]}>{due_date}</Text>
                                                        </View> : null
                                                }
                                                {
                                                    grandTotal ?
