                ...
                <Page size="A4" style={styles.page}>
                    <View style={styles.headerRow2}>
                        <View style={styles.col50}>
                            ...
                            <Text style={[styles.termText]}>Name: {customer_name}</Text>
                            <Text style={[styles.termText]}>Phone: {customer_phone}</Text>
                            <Text style={[styles.termText]}>NTN: {ntn}</Text>
                            <Text style={[styles.termText]}>STRN: {strn}</Text>
                            <Text style={[styles.termText]}>Email: {customer_email}</Text>
                        </View>
                    ...
                    <View style={styles.table}>
                        <View style={styles.tableRowHeader}>
                            ...
                            <Text style={[styles.colCost, styles.colorWhite]}>Discount %</Text>
                            <Text style={[styles.colCost, styles.colorWhite]}>Tax %</Text>
                            <Text style={[styles.colCost, styles.colorWhite]}>Tax</Text>
                        ...
                        {items.map((item, index) => (
                            <View style={styles.tableRow} key={index}>
                                ...
                                <Text style={styles.colCost}>{item.discount_percent}</Text>
                                <Text style={styles.colCost}>{item.tax_rate}</Text>
                                <Text style={styles.colCost}>{formatNumber(item.tax_amount)}</Text>
