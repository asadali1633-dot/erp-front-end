...
import style from './ProjectMngt.module.css'
import Heading from '../../../Components/Heading/Heading';
import { SearchBar } from '../../../Components/SearchBar/SearchBar';
import { OutLineButton } from '../../../Components/Button/Button';
import ProjectMngtForm from './Forms/ProjectMngtForm';

function ProjectMngt() {
    const [ProjectMngtFormModal, setProjectMngtFormModal] = useState(false)
    ...
    const handle = () => {
        setProjectMngtFormModal(!ProjectMngtFormModal)
    }
    ...
    return (
        <>
                ...
                <div className={`${style.PurchaseOrder_tableHeader}`}>
                    ...
                    <div className={`${style.PurchaseOrder_tableHeaderFlex}`}>
                        <SearchBar
                            ...
                            placeholder={"Search"}
                        />
                        <OutLineButton title={"Create Project"} onClick={handle} />
                    </div>
                </div>
                <Table
            ...
            {ProjectMngtFormModal && (
                <ProjectMngtForm {...{ ProjectMngtFormModal, setProjectMngtFormModal }} />
            )}
        </>
    )
}

export default ProjectMngt